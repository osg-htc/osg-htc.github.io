...
<div class="p-3 my-4 bg-white-offset fs-5 rounded shadow">
    ...
    <p class="text-center">
        ...
        <a href="{{ '/services/ospool.html' | relative_url }}">Open Science Pool (OSPool)</a> that is 
...
- Bringing the power of high throughput computing via the [OSPool](/services/ospool.html) to your researchers
...
- Developing science gateways to utilize high throughput computing via the [OSPool](/services/ospool.html)
...
via the [OSPool](/services/ospool.html), a compute resource accessible to any 
